...
var id = 0;
function generateId() {
    return md5(id++).toString().replace(/\d/g, function (num) {
...
var Coordinate = /** @class */ (function () {
    ...
    Coordinate.prototype.combineOptionsAndDefault = function () {
        this.tickOptions = __assign({}, this.defaultTick, this.options.tick);
        this.labelOptions = __assign({}, this.defaultLabel, this.options.label);
    };
    ...
    Coordinate.prototype.draw = function () {
        var _this = this;
        var g = this.options.baseChart.append('g')
            .attr('class', function () {
    ...
    Coordinate.prototype.applyStyle = function (color) {
        var ticks = select("#" + this.id)
            .selectAll('.tick');
        var text = ticks.select('text');
        if (typeof color === 'function') {
            ticks.data(Array(ticks.nodes().length).fill(0).slice().map(function (item, index) { return index; }));
...
var Root = /** @class */ (function () {
    ...
    Root.prototype.getSelection = function () {
 ...
 * 图标
 */
var Legen = /** @class */ (function (_super) {
    __extends(Legen, _super);
    function Legen(options) {
        var _this = _super.call(this) || this;
        _this.options = options;
        _this.observe = _this.options.observe;
        _this.state = _this.observe.get();
        _this.init();
        return _this;
    }
    Object.defineProperty(Legen.prototype, "store", {
        get: function () {
    ...
    Legen.prototype.init = function () {
        this.draw();
        this.bindEvent();
    };
    Legen.prototype.draw = function () {
        this.drawContainer();
        this.drawArc();
        this.drawText();
    };
    Legen.prototype.drawContainer = function () {
        var _this = this;
        this.selection = select("." + this.options.id)
            ...
            return "translate(" + (i * 80 + _this.options.series[i].name.length * 5) + ", 0)";
        });
    };
    Legen.prototype.drawArc = function () {
        var _this = this;
        var arcPath = arc();
    ...
    Legen.prototype.drawText = function () {
        var _this = this;
        this.selection.append('text')
            .html(function (d, i) {
            return _this.options.series[i].name;
        })
            .attr('x', 15)
            .attr('y', 5);
    };
    // 点击对应legend改变state.legend的值，让tooltip或line监听到这个变化，从而控制显示隐藏
    Legen.prototype.bindEvent = function () {
        var self = this;
        var dictionary = {};
        this.options.data.slice().forEach(function (d, index) {
            dictionary[d] = index;
        });
        this.selection.on('click', function (c, i) {
            var el = select(this);
            var index = self.store.indexOf(el.attr('class').replace(' legend-disActive', ''));
            if (!~el.attr('class').search('legend-disActive')) {
                self.state.legend.splice(index, 1);
                el.classed('legend-disActive', true);
            }
            else {
                var name_1 = el.attr('class').replace(' legend-disActive', '');
                self.state.legend.splice(dictionary[name_1], 0, name_1);
...
var Line = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Line.prototype, "chartOptions", {
        // 很多地方用到这个东西，可以用这个写法
        get: function () {
    ...
    Line.prototype.init = function () {
        ...
        this.options.series.forEach(function (serie) {
            var cur = parseInt(max$1(serie.data), 10);
            if (cur > rangeMax) {
                rangeMax = cur;
            }
        });
    ...
    Line.prototype.draw = function () {
        ...
        var input = Array(this.options.series.length).fill(0).slice().map(function (data, index) {
            return _this.domain.slice().map(function (innerData, innerIndex) {
    ...
    Line.prototype.moveCircles = function (newVal) {
        var _this = this;
        var yPos = this.options.series.slice().map(function (serie) {
            return serie.data[newVal];
        });
        var xPoint = this.xScale(this.options.domain[newVal]) + this.boundary.left;
        this.baseChart.selectAll('.circle-wrap')
            .data(this.options.series)
            .transition()
            .attr('transform', function (d, i) {
            return "translate(" + xPoint + ", " + (_this.yScale(yPos[i]) + _this.boundary.top) + ")";
        });
    };
    // 根据legend变化来控制线条和圆点的显示隐藏
    Line.prototype.visibleControl = function (newVal) {
        var lines = this.baseChart.selectAll('path');
        var circles = this.baseChart.selectAll('.circle-wrap');
        this.options.legend.forEach(function (val, index) {
            if (newVal.indexOf(val) === -1) {
                lines.filter(function (d, k) {
                    return k === index;
                }).classed('h3-hidden', true);
                circles.filter(function (d, k) {
                    return k === index;
                }).classed('h3-hidden', true);
            }
            else {
...
var Snapline = /** @class */ (function (_super) {
    ...
    Snapline.prototype.draw = function () {
    ...
    Snapline.prototype.move = function (newVal) {
        var xPoint = this.options.xScale(this.options.xAxis[newVal]) + this.container.boundary.left;
        this.selection.transition()
            .attr('x1', xPoint)
            .attr('x2', xPoint);
    };
    Snapline.prototype.visible = function (newVal, oldVal, state) {
        if (newVal === 'over') {
...
var Tooltip = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Tooltip.prototype, "itemSerie", {
        get: function () {
    ...
    Object.defineProperty(Tooltip.prototype, "itemTitle", {
        get: function () {
    ...
    Object.defineProperty(Tooltip.prototype, "itemValueAmount", {
        get: function () {
            return this.itemSerie.data.reduce(function (prev, next) {
    ...
    Object.defineProperty(Tooltip.prototype, "itemName", {
        get: function () {
    ...
    Object.defineProperty(Tooltip.prototype, "itemValue", {
        get: function () {
    ...
    Object.defineProperty(Tooltip.prototype, "itemRate", {
        get: function () {
    ...
    Tooltip.prototype.createElementOfAxis = function () {
    ...
    Tooltip.prototype.createDetail = function (detail) {
        var _this = this;
        if (typeof detail === 'string') {
            return "<li class=\"detail\">\n        <span class=\"point\"></span>\n        <span class=\"name\">" + detail + ": </span>\n        <span class=\"value\"></span>\n      </li>";
        }
        else {
            return detail.slice().map(function (d, i) {
                return "<li class=\"detail\"><span class=\"point\" style=\"background-color: " + _this.options.color[i] + "\"></span><span class=\"name\">" + d + ": </span><span class=\"value\"></span></li>";
            }).join('');
        }
    };
    Tooltip.prototype.visible = function (newVal) {
        var _this = this;
        if (newVal === 'over') {
            this.selection.style('transform', "translate(" + (this.state.mousePosition[0] + 20) + "px, " + (this.state.mousePosition[1] + 20) + "px)");
            setTimeout(function () {
                _this.selection.classed('h3-hidden', false);
            }, 100);
        }
        else {
            this.selection.classed('h3-hidden', true);
    ...
    Tooltip.prototype.createElementOfItem = function () {
        var _this = this;
        var prev = document.querySelector("." + this.options.id + " ~ .h3-tooltip");
        prev && prev.parentNode.removeChild(prev);
        var tooltip = document.createElement('div');
        tooltip.className = 'h3-tooltip h3-hidden';
        tooltip.innerHTML = this.options.formatter.replace(/{(\w)}/g, function ($1, $2) {
            switch (_this.dictionary[$2]) {
                case 'title':
                    return _this.itemTitle;
                case 'name':
                    return _this.itemName;
                case 'value':
                    return _this.itemValue;
                case 'rate':
                    return _this.itemRate;
            }
        });
        document.querySelector("." + this.options.id).parentElement.appendChild(tooltip);
        this.selection = select("." + this.options.id + " + .h3-tooltip");
    ...
    // tooltip跟着鼠标移动
    Tooltip.prototype.move = function (newVal) {
        var _this = this;
        if (this.options.type === 'axis') {
            ...
            this.selection.selectAll('.value')
                .data(this.options.series)
                .html(function (d, i) {
                return d.data[_this.state.index];
            });
            this.selection.transition()
                .duration(30)
    ...
    Tooltip.prototype.textControl = function (newVal) {
        var details = this.selection.selectAll('.detail');
        this.options.legend.forEach(function (val, index) {
            if (newVal.indexOf(val) === -1) {
                details.filter(function (d, k) {
                    return k === index;
    ...
    // 切换饼图区域
    Tooltip.prototype.changeItem = function (newVal) {
        var _this = this;
        this.itemSerie.data.some(function (d, i) {
            if (d.name === newVal) {
                _this.itemIndex = i;
                return true;
            }
        ...
        this.selection.html(this.options.formatter.replace(/{(\w)}/g, function ($1, $2) {
            switch (_this.dictionary[$2]) {
                case 'title':
                    return _this.itemTitle;
                case 'name':
...
var Observe = /** @class */ (function () {
    ...
    Observe.prototype.get = function () {
        return this.data;
    };
    Observe.prototype.push = function (data) {
        var _this = this;
        Object.keys(data).forEach(function (key) {
            if (!_this.watch.hasOwnProperty(key)) {
                _this.watch[key] = [];
                _this.watch[key].push(data[key]);
            }
            else {
                _this.watch[key].push(data[key]);
            }
    ...
    Observe.prototype.convert = function (data, watchKey) {
        var _this = this;
        Object.keys(data).forEach(function (key) {
            var resultKey = watchKey === '' ? key : watchKey + "." + key;
            var val = data[key];
            if (Object.prototype.toString.call(val).slice(8, -1) === 'Object') {
                _this.convert(val, resultKey);
            }
            _this.defineObject(data, val, key, resultKey === key ? key : resultKey);
            if (Object.prototype.toString.call(val).slice(8, -1) === 'Array') {
                _this.defineArray(val, key, resultKey === key ? key : resultKey);
            }
        });
    };
    Observe.prototype.defineObject = function (data, val, key, watchKey) {
        var self = this;
    ...
    Observe.prototype.defineArray = function (val, key, watchKey) {
        var _this = this;
        var arrayProto = Array.prototype;
        var arrayMethods = Object.create(arrayProto);
        ['pop', 'push', 'shift', 'unshift', 'splice', 'sort', 'reverse', 'slice'].forEach(function (method) {
    ...
    Observe.prototype.fire = function (watchKey, newVal, oldVal) {
        var _this = this;
        if (this.watch[watchKey] && this.watch[watchKey].length > 0) {
            if (this.verbose) {
                console.log("\"" + watchKey + "\": " + newVal + " --> " + oldVal);
            }
            this.watch[watchKey].forEach(function (fn) {
                fn(newVal, oldVal, _this.get());
            });
        }
    };
    return Observe;
...
var BaseChart = /** @class */ (function (_super) {
    ...
    Object.defineProperty(BaseChart.prototype, "width", {
        get: function () {
    ...
    Object.defineProperty(BaseChart.prototype, "height", {
        get: function () {
    ...
    BaseChart.prototype.initBaseChart = function () {
        this.drawStage();
        this.drawEventContainer();
    };
    // 绘制平台
    BaseChart.prototype.drawStage = function () {
    ...
    BaseChart.prototype.drawEventContainer = function () {
...
var LineChart = /** @class */ (function (_super) {
    ...
    LineChart.prototype.init = function () {
        this.observe = new Observe({
            data: {
                ...
                mouseState: 'out',
                legend: this.options.legend.slice()
            },
            verbose: false
        });
    ...
    Object.defineProperty(LineChart.prototype, "index", {
        get: function () {
    ...
    LineChart.prototype.drawSnapline = function () {
    ...
    LineChart.prototype.drawTooltip = function () {
        this.tooltip = new Tooltip({
            yName: this.options.series.slice().map(function (serie) {
                return serie.name;
            }),
            selector: this.options.selector,
            color: this.options.series.slice().map(function (serie) {
    ...
    LineChart.prototype.bindEvents = function () {
        var _this = this;
        this.eventContainer.on('mouseover', function () {
            mouse(_this.eventContainer.node());
            _this.state.mouseState = 'over';
        }).on('mouseout', function () {
            if (event.relatedTarget && event.relatedTarget.nodeName !== 'svg') {
                return;
            }
            _this.state.mouseState = 'out';
    ...
    LineChart.prototype.mouseMoveControler = function () {
        var _this = this;
        this.position = mouse(this.eventContainer.node());
        ...
        if (this.moveTimer === null) {
            this.moveTimer = setTimeout(function () {
                ...
                _this.moveTimer = null;
                if (_this.index === _this.state.index) {
                    return;
                }
                _this.state.index = _this.index;
            }, 200);
        }
    };
    // 计算当前鼠标所对应的横坐标的下标
    ...
    // 添加属性观察
    LineChart.prototype.addWatcher = function () {
...
var Legend$1 = /** @class */ (function (_super) {
    ...
    function Legend(options) {
        ...
        _this.options = __assign({}, options, _this.default);
        _this.init();
        return _this;
    }
    Legend.prototype.changeLegend = function (legend) {
        var dictionary = {};
        var self = this;
        (this.options.data).slice().forEach(function (d, index) {
        ...
        this.gs.on('click', function () {
            ...
            if (~el.attr('class').search('legend-disActive')) {
                el.classed('legend-disActive', false);
                var name_1 = el.attr('class').replace(' legend-disActive', '');
                legend.splice(dictionary[name_1], 0, name_1);
            }
            else {
    ...
    Object.defineProperty(Legend.prototype, "store", {
        get: function () {
            return this.options.data.map(function (d) { return d.name; });
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Legend.prototype, "iconSize", {
        get: function () {
    ...
    Object.defineProperty(Legend.prototype, "gap", {
        get: function () {
    ...
    Object.defineProperty(Legend.prototype, "width", {
        get: function () {
    ...
    Object.defineProperty(Legend.prototype, "height", {
        get: function () {
    ...
    Object.defineProperty(Legend.prototype, "top", {
        get: function () {
    ...
    Object.defineProperty(Legend.prototype, "left", {
        get: function () {
    ...
    Legend.prototype.drawContainer = function () {
    ...
    Legend.prototype.drawIcon = function () {
        var _this = this;
        this.gs.append('rect')
            ...
            .attr('y', function (d, i) {
            return i * (_this.iconSize.height + _this.gap);
        })
            .attr('rx', 3);
    };
    Legend.prototype.drawText = function () {
        var _this = this;
        this.gs.append('text')
...
var lightColor = function (hex, lightness) {
    var hsl = rgbToHsl.apply(rgbToHsl, hexToRgb(hex));
    var result = "hsl(" + (hsl[0]).toFixed(3) + ", " + parseInt(hsl[1], 10) + "%, " + (parseInt(hsl[2], 10) + lightness) + "%)";
    return result;
};
...
var PieChart = /** @class */ (function (_super) {
    ...
    function PieChart(options) {
        ...
        _this.arc = arc();
        _this.options = options;
        _this.observe = new Observe({
            data: {
                mousePosition: [0, 0],
                mouseState: 'out',
                itemName: '',
                pieLegend: _this.options.series[0].data.map(function (d) { return d.name; })
            }
        });
        _this.init();
        return _this;
    ...
    PieChart.prototype.initData = function () {
        this.options.series.map(function (serie) {
            if (typeof serie.data === 'function') {
                serie.data = serie.data();
            }
    ...
    Object.defineProperty(PieChart.prototype, "state", {
        get: function () {
    ...
    Object.defineProperty(PieChart.prototype, "serie", {
        get: function () {
            return this.options.series[0];
        },
        enumerable: true,
    ...
    Object.defineProperty(PieChart.prototype, "data", {
        get: function () {
            var _this = this;
            return this.serie.data.slice().filter(function (d, i) {
                if (!~_this.state.pieLegend.indexOf(d.name)) {
                    return false;
                }
                return true;
            });
    ...
    Object.defineProperty(PieChart.prototype, "pieData", {
        get: function () {
            var _this = this;
            return pie().value(function (d) {
                return d.value;
    ...
    Object.defineProperty(PieChart.prototype, "position", {
        get: function () {
    ...
    Object.defineProperty(PieChart.prototype, "outerRadius", {
        get: function () {
    ...
    PieChart.prototype.convertStringToNumber = function (str) {
    ...
    PieChart.prototype.drawPie = function () {
        ...
        this.arcs
            ...
            .attr('fill', function (d) {
            return lightColor(d.data.color, 0);
        });
    };
    PieChart.prototype.drawText = function () {
        ...
        this.arcs
            ...
            .append('text')
            .attr('transform', function (d) {
            var x = _this.arc.centroid(d)[0] * 2.5;
            var y = _this.arc.centroid(d)[1] * 2.5;
    ...
    PieChart.prototype.drawLine = function () {
        var _this = this;
        this.arcs
            .data(this.pieData)
            .enter()
            ...
            .attr('x1', function (d) {
            return _this.arc.centroid(d)[0] * 2;
        })
            .attr('y1', function (d) {
            return _this.arc.centroid(d)[1] * 2;
        })
            .attr('x2', function (d) {
            return _this.arc.centroid(d)[0] * 2.25;
        })
            .attr('y2', function (d) {
            return _this.arc.centroid(d)[1] * 2.25;
        });
    };
    PieChart.prototype.drawTooltip = function () {
        this.tooltip = new Tooltip({
            selector: this.options.selector,
            type: 'item',
            id: this.id,
    ...
    PieChart.prototype.choose = function () {
        var self = this;
        select("." + this.id).on('mouseover', function () {
            if (event.relatedTarget && event.relatedTarget.nodeName === 'svg' && event.srcElement.nodeName === 'path') {
                ...
                self.state.mouseState = 'over';
                var to = select(event.srcElement);
                var from = select(event.relatedTarget);
                from.attr('fill', function (d) {
                    return lightColor(d.data.color, -4);
                });
                to.attr('fill', function (d) {
                    return lightColor(d.data.color, 4);
                });
            }
...
var lineChart = new LineChart({
    ...
    tooltip: {
        title: Array(14).fill(0).slice().map(function (d, i) { return i + 2000; })
    },
    ...
    xAxis: {
        data: Array(14).fill(0).slice().map(function (d, i) { return i + 2000; })
    },
    series: [{
            name: 'China',
            type: 'broken',
